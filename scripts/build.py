#!/usr/bin/env python3
"""Assembles the static Studio Kiem site from src/partials + src/pages.
...
PAGES = [
    ("index.html", "index.html",
     "Studio Kiem — Stijlvolle hoezen voor bakfietsschalen",
     "Studio Kiem maakt hoogwaardige hoezen voor Melia baby- en peuterschalen in merinowol, outdoorstof en mousseline."),
    ("shop.html", "shop.html",
     "Alle hoezen — Studio Kiem",
     "Alle hoezen van Studio Kiem voor de Melia babyschaal en peuterschaal. Filter op schaal, materiaal, seizoen of kleur."),
    ("product.html", "product.html",
     "Hoes voor Melia schaal — Studio Kiem",
    ...
    ("compatibiliteit-babyschaal.html", "compatibiliteit-babyschaal.html",
     "Melia babyschaal — Compatibiliteit — Studio Kiem",
    ...
    ("compatibiliteit-peuterschaal.html", "compatibiliteit-peuterschaal.html",
     "Melia peuterschaal — Compatibiliteit — Studio Kiem",
    ...
    ("babyschaal-hoezen.html", "babyschaal-hoezen.html",
     "Babyschaal hoezen voor de bakfiets — Studio Kiem",
